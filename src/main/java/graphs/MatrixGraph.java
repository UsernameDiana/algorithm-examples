...
public class MatrixGraph<D, W> implements Graph<D, W> {
    ...
    public void print(PrintStream out) {
        ...
        for (int i = 0; i < data.length; i++) {
            out.printf("\n%3d | %-8s    %3d | ", i, data[i], i);
            for (int j = 0; j < data.length; j++) {
                out.printf("%4s", weights[i][j] == null ? "." : weights[i][j]);
            }
        }
        out.println();
        out.println();
    ...
    public final void addVertex(D... newData) {
        ...
        for (int i = 0; i < newSize; i++) {
            if (i < data.length) {
                ...
                tempData[i] = newData[i - data.length];
            }
        }
        this.data = tempData;
...
//      return result;
        ...
        public boolean equals(Object other) {
            ...
            if (!(other instanceof MatrixGraph.MatrixVertex)) {
                return false;
            }
    ...
    private class MatrixEdge implements Edge<D, W> {
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof MatrixGraph.MatrixEdge)) {
                return false;
            }
